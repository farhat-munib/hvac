  ...
  return (
    <section className="py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-5 lg:px-8">
        <div className="relative overflow-hidden rounded-[28px] bg-clay-500 px-7 py-10 text-white shadow-soft-lg sm:px-12 lg:py-12">
          {/* Soft glow inside */}
          <div
          ...
          <div className="relative mt-9 flex flex-col gap-3 border-t border-dashed border-white/30 pt-7 sm:flex-row sm:items-center">
            <a
              href="#contact"
              className="group flex items-center justify-center gap-2 rounded-full bg-white px-7 py-3.5 text-base font-bold text-clay-600 transition-all hover:-translate-y-0.5 hover:bg-paper"
            >
              Claim this offer
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-full border border-white/40 px-7 py-3.5 text-base font-bold text-white transition-colors hover:bg-white/10"
            >
